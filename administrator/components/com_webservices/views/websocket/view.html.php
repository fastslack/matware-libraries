 ...
 * @since       1.0
 */
class WebservicesViewWebsocket extends JViewLegacy
{
	/**
	 * @var  JForm
	 */
	...
	{
		return JText::_('COM_WEBSERVICES_WEBSOCKET_TITLE');
	}
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_WEBSERVICES_MANAGER_WEBSOCKET'), 'webservices.png');
