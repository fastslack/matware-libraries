 ...
 * @since       1.0
 */
class WebservicesModelJs extends JModelAdmin
{
	/**
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Js', $prefix = 'WebservicesTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_webservices.js', 'token', array('control' => 'jform', 'load_data' => $loadData));
