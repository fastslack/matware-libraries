...
class MOauth2ProtocolRequest
{
	 ...
	 * @since   1.0
	 */
	public function __construct(MOauth2TableCredentials $table = null)
	{
		...
		$this->_response = new MOauth2ProtocolResponse;
	}
	...
	public function fetchMessageFromRequest()
	{
		...
		// Loading the response class
		$requestHeader = new MOauth2ProtocolRequestHeader;
		...
		$class = "MOauth2ProtocolRequest" . ucfirst($method);
